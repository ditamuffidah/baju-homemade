...
@section('content')
    <section class="py-5" style="margin-top: 100px">
        <div class="container col-xxl-8">
            <h4>Halaman Pemesanan</h4>

            <a href="{{ route('pemesanan.create') }}" class="btn btn-primary">Buat Pesanan</a>
            ...
            @foreach (auth()->user()->notifications as $notification)
                <div class="alert alert-info">
                    ...
                    <a href="{{ route('pemesanan.show', $notification->data['pemesanan_id']) }}">Lihat Pesanan</a>
                </div>
            @endforeach
            @else
